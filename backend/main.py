...
from .modules.government.gov_routes import gov_router
...
# Mount Government Multi-Tenant REST API router
app.include_router(gov_router, prefix="/api/v1/government", tags=["Government Multi-Tenant Operations"])
